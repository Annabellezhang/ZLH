...
public class TaxiTenBusy {
    ...
    public static class Map1 extends Mapper<LongWritable, Text, Text, IntWritable> {
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            if (key.get() > 0) {
                ...
                String pick_long = lines[10];
                String pick_lati = lines[11];
                String pick = pick_long+pick_lati;
                context.write(new Text(pick), new IntWritable(1));
    ...
    public static void main(String[] args) throws Exception {
        ...
        Path temp1 = new Path("temp5");
        
        
        Configuration conf = new Configuration();
        
        Job job1 = new Job(conf, "taxipick-top-10-pass-1");
        ...
        job1.setJarByClass(TaxiTenBusy.class);
        ...
        Job job2 = new Job(conf, "taxipick-top-10-pass-2");
        ...
        job2.setJarByClass(TaxiTenBusy.class);
